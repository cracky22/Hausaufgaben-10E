...
<head>
  ...
  <title>Hausaufgaben 9E login</title>
</head>

<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
  <header class="mdl-layout__header">
    <div class="mdl-layout__header-row">
      <span class="mdl-layout-title">Hausaufgaben 9E</span>
      ...
      <ul class="mdl-menu mdl-menu--bottom-right mdl-js-menu mdl-js-ripple-effect" for="demo-menu-lower-right">
        ...
        <a style="color: black; text-decoration: none;" href="./HomeWorkData.html">
          <li class="mdl-menu__item">Hausaufgaben anzeigen <b>[Gast]</b></li>
        </a>
        <a style="color: black; text-decoration: none;" href="#guesLogin=false;" disabled>
          <li class="mdl-menu__item" disabled>Gast Login <i>[Inaktiv]</i></li>
        </a>
        <a style="color: black; text-decoration: none;" href="#adminLogin=false;" disabled>
          <li class="mdl-menu__item" disabled><b>Admin Login <i>[Inaktiv]</i></b></li>
        </a>
        <a style="color: black; text-decoration: none;" onclick="location.reload();" disabled>
          <li class="mdl-menu__item">Seite Neu Laden</li>
        </a>
      </ul>
    </div>
  </header>
  <div class="mdl-layout__drawer">
    ...
    <nav class="mdl-navigation">
      <a class="mdl-navigation__link" href="#main" disabled>Anmelden für Menü</a>
    </nav>
  </div>
    ...
    <div class="page-content">
      <center>
        <form action="" method="post" name="Login_Form">
          <h3 id="main" style="font-family: CabinSketch!important;">Login</h3>
