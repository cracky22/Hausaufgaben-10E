	...
	<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
		<header class="mdl-layout__header">
			<div class="mdl-layout__header-row">
				<span class="mdl-layout-title">Kontakt</span>
		...
		<div class="mdl-layout__drawer">
			...
			<nav class="mdl-navigation">
				...
				<a class="mdl-navigation__link" title="E-Mail schreiben"
					href="./contact.php?comeFrom=./contact.php">&#128231;&nbsp;Kontakt</a>
				...
				<center>
					...
					onclick="openInMail()">
						<span class="mdl-chip mdl-chip--contact">
							<span class="mdl-chip__contact mdl-color--teal mdl-color-text--white">MB</span>
							<span class="mdl-chip__text">Kontaktiere mich</span>
						</span><br><br>
					</button>
